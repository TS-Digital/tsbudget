    ...
    <div className="flex items-start gap-3 p-4 rounded-xl border border-[#fb923c]/30 bg-[#fb923c]/5 text-sm">
      ...
      <p className="text-[#7a8599]">
        ...
        <a
          ...
          className="underline hover:text-[#e8eaf0] transition-colors"
        >
  ...
  return (
    <>
      ...
      <main className="mx-auto max-w-6xl px-4 py-8 space-y-10">
        ...
        <section>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {INVESTMENT_VEHICLES.map((v) => (
              <div
                key={v.name}
                className="rounded-2xl border border-[#2a3447] bg-[#141920] p-5 flex flex-col"
              >
                ...
                <p className="text-sm text-[#7a8599] flex-1 leading-relaxed mb-4">{v.desc}</p>

                <div className="space-y-1.5 mb-4 text-xs">
                  <div className="flex justify-between">
                    <span className="text-[#7a8599]">Annual limit</span>
                    <span className="font-medium text-[#e8eaf0]">{v.limit}</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-[#7a8599]">Tax benefit</span>
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-xs font-semibold text-[#7a8599] hover:text-[#c9a84c] transition-colors"
                >
        ...
        <footer className="text-center text-xs text-[#7a8599] pb-4">
          TSBudget provides estimates for guidance only. Consult a qualified accountant or
