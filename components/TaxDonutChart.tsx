...
export default function TaxDonutChart({ breakdown: b }: Props) {
  ...
  return (
    <div className="rounded-2xl border border-[#2a3447] bg-[#141920] p-6">
      ...
      <p className="text-xs text-[#7a8599] mb-4">Annual breakdown</p>
      ...
      <div className="text-center mb-2">
        ...
        <div className="text-xs text-[#7a8599] mt-1">annual take-home</div>
      </div>
      ...
      <ResponsiveContainer width="100%" height={220}>
        <PieChart>
          ...
          <Legend
            iconType="circle"
            iconSize={8}
            formatter={(value) => <span style={{ color: '#7a8599', fontSize: '12px' }}>{value}</span>}
          />
        </PieChart>
      </ResponsiveContainer>
    </div>
